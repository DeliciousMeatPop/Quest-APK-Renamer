...
| Android SDK Platform-Tools | Resolved at Windows/macOS build time | Android SDK terms | [Android developer tools](https://developer.android.com/tools/releases/platform-tools) |
| Eclipse Temurin | JRE 21, resolved at Windows/macOS build time | GPLv2 with Classpath Exception and related notices | [Eclipse Adoptium](https://adoptium.net/) |

Exact hashes for the two repository-bundled JARs are recorded in
`tools/versions.json`. Windows and macOS builds also generate a
